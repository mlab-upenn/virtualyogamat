...
function uploadVid() {
  ...
  $("#addVideo").css("padding-top", "1em");
  $("#vidURL").css("display", "none");
  $("#loadBtn").css("display", "none");
  $("#sampleVideos").css("display", "none");
...
function designContent() {
  ...
  $("#yogaPoseButton").css("display", "block");
  // $("#videoButtons").css("display", "none");
  $("#poseNumber").html("Pose 0");
  $("#descWrapper").css("display", "block");
}
...
function displayUI() {
  ...
  if(player != undefined) {
    ...
    $("#videoButtons").css("display", "block");
...
function toggleModes() {
  if(viewMode) {
    $("#mode").html("View Mode");
    $("#sliderWrapper").css("display", "block");
    $("#poseName").css("display", "block");
    $("#poseNameP").css("display", "none");
    $("#poseDescriptionP").css("display", "none");
    $("#yogaPoseDescription").css("display", "block");
    $(".buttonControls").css("display", "block");
    $("#videoButtons").css("display", "block");
  } else {
    $("#mode").html("Authoring Mode");
    // $("#sliderWrapper").css("display", "none");
    $("#poseName").css("display", "none");
    $("#yogaPoseDescription").css("display", "none");
    $("#poseNameP").css("display", "block");
    $("#poseDescriptionP").css("display", "block");
